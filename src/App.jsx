...
export const TR = {
  fr: {
    ...
    landingHeroTitle: "Tu vends ce plat tous les jours. Sais-tu ce qu'il te rapporte vraiment ?",
    landingHeroSubtitle: "Chefup calcule ta marge en temps réel à partir de tes vraies factures — scanne, et c'est fait.",
    ...
    landingPreviewCost: "Coût ingrédients", landingPreviewPrice: "Prix de vente",
  ...
  es: {
    ...
    landingHeroTitle: "Vendes este plato todos los días. ¿Sabes realmente cuánto te deja?",
    landingHeroSubtitle: "Chefup calcula tu margen en tiempo real a partir de tus facturas reales — escanea, y ya está.",
    ...
    landingPreviewCost: "Coste ingredientes", landingPreviewPrice: "Precio de venta",
  ...
  en: {
    ...
    landingHeroTitle: "You sell this dish every day. Do you actually know what it earns you?",
    landingHeroSubtitle: "Chefup calculates your margin in real time from your real invoices — scan it, and it's done.",
    ...
    landingPreviewCost: "Ingredient cost", landingPreviewPrice: "Sell price",
