...
export const TR = {
  fr: {
    ...
    landingHeroSubtitle: "Chefup calcule ta marge en temps réel à partir de tes vraies factures — scanne, et c'est fait. Fiches techniques et fiche allergènes prêtes à imprimer.",
  ...
  es: {
    ...
    landingHeroSubtitle: "Chefup calcula tu margen en tiempo real a partir de tus facturas reales — escanea, y ya está. Fichas técnicas y ficha de alérgenos listas para imprimir.",
  ...
  en: {
    ...
    landingHeroSubtitle: "Chefup calculates your margin in real time from your real invoices — scan it, and it's done. Printable spec sheet and allergen sheet included.",
