...
export const TR = {
  fr: {
    ...
    landingHeroSubtitle: "Scanne tes factures : Chefup calcule la marge réelle de chaque plat et te montre lesquels te plombent. Fiches techniques et allergènes prêtes à imprimer.",
  ...
  es: {
    ...
    landingHeroSubtitle: "Escanea tus facturas: Chefup calcula el margen real de cada plato y te muestra cuáles te hunden. Fichas técnicas y de alérgenos listas para imprimir.",
  ...
  en: {
    ...
    landingHeroSubtitle: "Scan your invoices: Chefup works out the real margin on every dish and shows you which ones are dragging you down. Printable spec and allergen sheets included.",
