...
export const TR = {
  fr: {
    ...
    landingHeroTitle: "Connais la marge exacte de chaque plat de ta carte",
    landingHeroSubtitle: "Scanne tes factures fournisseurs : Chefup met tes coûts à jour tout seul et recalcule tes marges. Fiches techniques et allergènes prêtes à imprimer.",
  ...
  es: {
    ...
    landingHeroTitle: "Conoce el margen exacto de cada plato de tu carta",
    landingHeroSubtitle: "Escanea las facturas de tus proveedores: Chefup actualiza tus costes solo y recalcula tus márgenes. Fichas técnicas y de alérgenos listas para imprimir.",
  ...
  en: {
    ...
    landingHeroTitle: "Know the exact margin on every dish on your menu",
    landingHeroSubtitle: "Scan your supplier invoices: Chefup updates your costs on its own and recalculates your margins. Printable spec and allergen sheets included.",
