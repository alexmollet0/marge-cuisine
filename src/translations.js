...
export const TR = {
  fr: {
    ...
    tutorial_scan_body: "Prends en photo une facture (ou choisis un fichier PDF) : les prix de tes ingrédients se mettent à jour tout seuls, sans rien retaper.",
  ...
  es: {
    ...
    tutorial_scan_body: "Haz una foto a una factura (o elige un PDF): los precios de tus ingredientes se actualizan solos, sin volver a teclear nada.",
  ...
  en: {
    ...
    tutorial_scan_body: "Take a photo of an invoice (or pick a PDF): your ingredient prices update themselves, nothing to retype.",
