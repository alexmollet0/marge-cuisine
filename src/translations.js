...
export const TR = {
  fr: {
    ...
    tutorialScanWowMessage: "Voilà ce qui se passe à chaque facture que tu scannes.",
  ...
  es: {
    ...
    tutorialScanWowMessage: "Esto es lo que pasa cada vez que escaneas una factura.",
  ...
  en: {
    ...
    tutorialScanWowMessage: "This is what happens every time you scan an invoice.",
