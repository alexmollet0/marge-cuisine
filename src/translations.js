...
export const TR = {
  fr: {
    ...
    recipes: "Recettes", avgMarginLabel: "marge moyenne", newRecipe: "Nouvelle recette", newRecipeName: "Nouvelle recette",
    newRecipeChoiceTitle: "Comment veux-tu créer ta recette ?",
    newRecipeFromScratch: "Partir de zéro",
    expressRecipeOption: "Recette express",
    expressRecipeHint: "Tape le nom d'un plat, l'app propose les ingrédients et les quantités avec des prix estimés — à corriger avec tes vraies factures.",
    expressRecipeNamePlaceholder: "Ex : Salade César",
    expressRecipePortionsLabel: "Portions",
    expressRecipeGenerateButton: "Générer",
    expressRecipeLoading: "Génération en cours…",
    expressRecipeError: "Impossible de générer cette recette pour le moment. Réessaie, ou pars d'une fiche vide.",
    // "Plat du jour" (2026-09-08) — voir CLAUDE.md.
    dailyDishTab: "Plats du jour", newDailyDish: "Nouveau plat du jour",
    dailyDishHint: "L'app propose un plat à partir de ce qu'il y a déjà dans ton garde-manger, ou tu ajoutes toi-même tes ingrédients — les deux avec un prix de vente déjà réglé pour voir ta marge tout de suite.",
    dailyDishNamePlaceholder: "Nom du plat (optionnel)",
    dailyDishNameToggle: "+ Donner un nom (optionnel)",
    dailyDishWantedLabel: "Ingrédients à utiliser (optionnel)",
    dailyDishWantedPlaceholder: "Ex : poulet, steak haché",
    dailyDishExcludedLabel: "Ingrédients à éviter (optionnel)",
    dailyDishExcludedPlaceholder: "Ex : bœuf, saumon",
    dailyDishPreviewHint: "Rien n'est encore créé. Un ingrédient te manque ? Retire-le : une nouvelle proposition cohérente sans lui est générée.",
    dailyDishRemoveLine: "Je n'ai pas ça",
    dailyDishPreviewCost: "Coût total :", dailyDishPreviewMargin: "Marge :",
    dailyDishValidateButton: "Valider ce plat", dailyDishRegenerateButton: "Recommencer",
    dailyDishFromStockButton: "Proposer un plat", dailyDishQuickAddButton: "Ajout rapide (sans IA)",
    dailyDishDefaultName: "Plat du jour",
    noDailyDishYet: "Aucun plat du jour pour l'instant.",
    ...
    quickAddEstimateHint: "Tape n'importe quel ingrédient : un prix estimé se remplit tout seul, à corriger plus tard si besoin.",
    ...
    recipeVatLabel: "TVA de cette recette", recipeVatResetToDefault: (rate) => `Revenir à la TVA par défaut (${rate}%)`,
    menuPriceOutdatedHint: "Le prix affiché sur ta carte n'est pas encore à jour.", menuPricePushButton: "Mettre à jour sur la carte", menuPricePushSuccess: "Prix mis à jour sur la carte digitale.",
    saveRecipeButton: "Sauvegarder", saveRecipeSaving: "Sauvegarde…", saveRecipeSaved: "Enregistré", saveRecipeError: "Échec de la sauvegarde, réessaie.",
    addToMenuButton: "Ajouter à la carte digitale", onMenuLabel: "Sur la carte digitale", addToMenuTitle: "Ajouter à la carte digitale",
    addToMenuHint: (name) => `Choisis la section où "${name}" doit apparaître sur ta carte publique.`,
    menuSectionPickLabel: "Section", addToMenuConfirm: "Ajouter",
    digitalMenuFromRecipeHint: "Vient d'une recette", digitalMenuRemoveFromMenu: "Retirer de la carte",
    digitalMenuDishesLabel: "Plats de la carte", digitalMenuPickRecipeButton: "Ajouter une recette déjà existante",
    digitalMenuNoPickableRecipes: "Toutes tes recettes sont déjà sur la carte, ou aucune ne correspond.",
    digitalMenuManageSections: "Réorganiser les sections", digitalMenuQuickAddLabel: "Ajoute ton plat et son prix",
    digitalMenuNoDishesYet: "Aucun plat sur la carte pour l'instant.",
    digitalMenuPersonalizeButton: "Personnaliser ma carte", digitalMenuViewCardButton: "Voir ma carte", digitalMenuAddDishesButton: "Ajouter des plats",
    ...
    launchSpotsLeft: (n) => (n > 1 ? `Plus que ${n} places` : n === 1 ? "Dernière place !" : "Toutes les places sont prises"),
    ...
    menuWizardStep1Title: "Comment s'appelle ton restaurant ?",
    menuWizardStep1Hint: "C'est le nom que tes clients verront en haut de la carte.",
    menuWizardNamePlaceholder: "Chez Marius, La Table d'Or…",
    menuWizardStep2Title: "Ajoute tes plats",
    menuWizardStep2Hint: "Choisis une section, puis tape tes plats les uns après les autres. Tu pourras tout modifier plus tard.",
    menuWizardDishPlaceholder: "Burger maison, Coca 33cl…",
    menuWizardDishTip: "Astuce : appuie sur Entrée pour enchaîner le plat suivant.",
    menuWizardStep3Title: "Choisis ton style",
    menuWizardStep3Hint: "L'allure de ta carte quand un client scanne le QR code.",
    menuWizardStep4Title: "Ta carte est prête !",
    menuWizardStep4Hint: "Imprime ce QR code et pose-le sur tes tables. Tes prix se mettront à jour tout seuls.",
    menuWizardPreview: "Voir ma carte comme un client",
    menuWizardNext: "Continuer",
    menuWizardPublish: "Publier ma carte",
    menuWizardQrLater: "Ton QR code apparaîtra ici dès que ta carte sera enregistrée.",
    menuWizardNewSectionPlaceholder: "Nouvelle section (Pizzas, Sauces…)",
    menuWizardEmptySection: "Aucun plat dans cette section pour l'instant.",
    menuWizardPublished: "Carte publiée",
    menuWizardAdvanced: "Réglages avancés (logo, couleurs, recettes…)",
    menuWizardBackToSimple: "← Revenir à l'éditeur simple",
    ...
    scanPriceInconsistent: "Écart avec le total imprimé — souvent une taxe (accise, éco-contribution...) non détaillée séparément, pas forcément une erreur.",
    scanExpectedTotal: "attendu", scanPrintedTotal: "imprimé :",
    scanPriceInconsistentNote: "Petit écart avec le total imprimé (souvent une taxe à part) — jette un œil si tu veux, pas forcément une erreur.",
    scanPackagePriceUncertain: "Ce prix au kg/L n'a pas pu être vérifié automatiquement — cette facture semble compter autrement (ex: prix par bouteille dans un lot) que ce que l'app sait lire. Vérifie-le avant d'importer.",
    ...
    digitalMenuHint: "Génère une carte publique (avec QR code) à partir de tes recettes et de tes plats. Pour une recette, mets à jour le prix affiché quand tu veux, en un clic depuis sa fiche.",
    ...
    digitalMenuRecipesLabel: "Recettes affichées sur la carte", digitalMenuNoRecipes: "Crée une recette pour pouvoir l'ajouter à la carte.", digitalMenuRecipeFilterPlaceholder: "Chercher une recette...",
    ...
    digitalMenuPreview: "Voir la carte", digitalMenuQrAfterPublish: "Le QR code apparaît une fois la carte publiée.", digitalMenuTranslateHint: "Traduire vers :",
    ...
    marginBelowFloorMsg: "Ta cible personnalisée est atteinte, mais la marge reste sous le seuil de sécurité de 70% — à surveiller quand même.",
    ...
    landingHeroSubtitle: "Regarde ce qui se passe à chaque facture que tu scannes.",
    landingWowScanning: "Scan en cours...",
    landingWowResultBanner: "5 lignes importées",
    landingWowSupplier: "Metro · 12 mars",
    landingWowResultConfirm: "Prix mis à jour automatiquement",
    landingWowLater: "Quelques semaines plus tard, la facture change...",
    landingWowRecipeIntro: "Ta recette « Bœuf bourguignon » le sait déjà",
    landingWowRecipeOutro: "Vu et corrigé avant que ça ne te coûte cher — pas à la fin du mois.",
    ...
    reopenTutorialButton: "Revoir le tutoriel",
    tutorial_welcome_title: "Bienvenue sur Chefup",
    tutorial_welcome_body: "L'app qui calcule la marge de chacun de tes plats, automatiquement. Petit tour en 3 étapes avant de commencer.",
    tutorial_scan_title: "Scanne tes factures fournisseurs",
    tutorial_scan_body: "Touche la facture ci-dessous pour voir ce qui se passe à chaque vrai scan : les prix se remplissent tout seuls, sans rien retaper.",
    tutorialScanTapPrompt: "Toucher pour scanner",
    tutorialWowCTA: "C'est parti !",
    tutorialWowResultBanner: "5 lignes importées",
    tutorialWowSupplier: "Metro · 12 mars",
    tutorialWowResultConfirm: "Prix mis à jour dans ton garde-manger",
    tutorialWowLater: "Quelques semaines plus tard, tu rescannes la même facture...",
    tutorialWowRecipeIntro: "Ta recette « Bœuf bourguignon » le sait déjà",
    tutorialWowRecipeOutro: "Tu vois l'impact tout de suite — pas à la fin du mois.",
    tutorial_recipe_title: "Crée tes recettes",
    tutorial_recipe_body: "Ajoute les ingrédients d'un plat et son prix de vente : la marge se calcule toute seule, et se met à jour dès qu'un prix change.",
    tutorial_allergens_title: "Ta fiche allergènes, générée toute seule",
    tutorial_allergens_body: "Chaque allergène est détecté automatiquement à partir des ingrédients de tes recettes — imprime une fiche complète en un clic, jamais besoin de la remplir à la main.",
    tutorial_technicalSheet_title: "Une fiche technique prête à imprimer",
    tutorial_technicalSheet_body: "Chaque recette a sa propre fiche technique imprimable : ingrédients, quantités, allergènes — parfaite à glisser dans un classeur ou à afficher en cuisine.",
    tutorial_digitalMenu_title: "Ta carte digitale en quelques clics",
    tutorial_digitalMenu_body: "Transforme tes recettes en une vraie carte publique avec QR code, à poser sur tes tables ou partager en ligne — sans rien redessiner.",
    tutorial_pantry_title: "Ton garde-manger toujours à jour",
    tutorial_pantry_body: "Chaque ingrédient garde son historique de prix par fournisseur — tu vois tout de suite si un prix a augmenté, et son impact sur tes marges.",
  ...
  es: {
    ...
    recipes: "Recetas", avgMarginLabel: "margen medio", newRecipe: "Nueva receta", newRecipeName: "Nueva receta",
    newRecipeChoiceTitle: "¿Cómo quieres crear tu receta?",
    newRecipeFromScratch: "Empezar de cero",
    expressRecipeOption: "Receta exprés",
    expressRecipeHint: "Escribe el nombre de un plato, la app propone los ingredientes y las cantidades con precios estimados — corrígelos con tus facturas reales.",
    expressRecipeNamePlaceholder: "Ej: Ensalada César",
    expressRecipePortionsLabel: "Raciones",
    expressRecipeGenerateButton: "Generar",
    expressRecipeLoading: "Generando…",
    expressRecipeError: "No se pudo generar esta receta ahora mismo. Vuelve a intentarlo, o empieza con una ficha vacía.",
    dailyDishTab: "Platos del día", newDailyDish: "Nuevo plato del día",
    dailyDishHint: "La app propone un plato a partir de lo que ya tienes en tu almacén, o añades tú mismo tus ingredientes — ambos con un precio de venta ya puesto para ver tu margen al instante.",
    dailyDishNamePlaceholder: "Nombre del plato (opcional)",
    dailyDishNameToggle: "+ Poner un nombre (opcional)",
    dailyDishWantedLabel: "Ingredientes a usar (opcional)",
    dailyDishWantedPlaceholder: "Ej: pollo, carne picada",
    dailyDishExcludedLabel: "Ingredientes a evitar (opcional)",
    dailyDishExcludedPlaceholder: "Ej: ternera, salmón",
    dailyDishPreviewHint: "Nada se ha creado todavía. ¿Te falta un ingrediente? Quítalo: se genera una nueva propuesta coherente sin él.",
    dailyDishRemoveLine: "No tengo esto",
    dailyDishPreviewCost: "Coste total:", dailyDishPreviewMargin: "Margen:",
    dailyDishValidateButton: "Validar este plato", dailyDishRegenerateButton: "Volver a generar",
    dailyDishFromStockButton: "Proponer un plato", dailyDishQuickAddButton: "Añadir rápido (sin IA)",
    dailyDishDefaultName: "Plato del día",
    noDailyDishYet: "Ningún plato del día por ahora.",
    ...
    quickAddEstimateHint: "Escribe cualquier ingrediente: se rellena solo con un precio estimado, corrígelo más tarde si hace falta.",
    ...
    recipeVatLabel: "IVA de esta receta", recipeVatResetToDefault: (rate) => `Volver al IVA por defecto (${rate}%)`,
    menuPriceOutdatedHint: "El precio de tu carta aún no está actualizado.", menuPricePushButton: "Actualizar en la carta", menuPricePushSuccess: "Precio actualizado en la carta digital.",
    saveRecipeButton: "Guardar", saveRecipeSaving: "Guardando…", saveRecipeSaved: "Guardado", saveRecipeError: "Error al guardar, inténtalo de nuevo.",
    addToMenuButton: "Añadir a la carta digital", onMenuLabel: "En la carta digital", addToMenuTitle: "Añadir a la carta digital",
    addToMenuHint: (name) => `Elige la sección donde "${name}" debe aparecer en tu carta pública.`,
    menuSectionPickLabel: "Sección", addToMenuConfirm: "Añadir",
    digitalMenuFromRecipeHint: "Viene de una receta", digitalMenuRemoveFromMenu: "Quitar de la carta",
    digitalMenuDishesLabel: "Platos de la carta", digitalMenuPickRecipeButton: "Añadir una receta ya existente",
    digitalMenuNoPickableRecipes: "Todas tus recetas ya están en la carta, o ninguna coincide.",
    digitalMenuManageSections: "Reorganizar las secciones", digitalMenuQuickAddLabel: "Añade tu plato y su precio",
    digitalMenuNoDishesYet: "Ningún plato en la carta por ahora.",
    digitalMenuPersonalizeButton: "Personalizar mi carta", digitalMenuViewCardButton: "Ver mi carta", digitalMenuAddDishesButton: "Añadir platos",
    ...
    launchSpotsLeft: (n) => (n > 1 ? `Solo quedan ${n} plazas` : n === 1 ? "¡Última plaza!" : "Todas las plazas están ocupadas"),
    ...
    menuWizardStep1Title: "¿Cómo se llama tu restaurante?",
    menuWizardStep1Hint: "Es el nombre que tus clientes verán arriba de la carta.",
    menuWizardNamePlaceholder: "Casa Marius, La Mesa de Oro…",
    menuWizardStep2Title: "Añade tus platos",
    menuWizardStep2Hint: "Elige una sección y escribe tus platos uno tras otro. Podrás modificarlo todo más tarde.",
    menuWizardDishPlaceholder: "Hamburguesa casera, Coca 33cl…",
    menuWizardDishTip: "Truco: pulsa Intro para pasar al siguiente plato.",
    menuWizardStep3Title: "Elige tu estilo",
    menuWizardStep3Hint: "El aspecto de tu carta cuando un cliente escanea el código QR.",
    menuWizardStep4Title: "¡Tu carta está lista!",
    menuWizardStep4Hint: "Imprime este código QR y ponlo en tus mesas. Tus precios se actualizarán solos.",
    menuWizardPreview: "Ver mi carta como un cliente",
    menuWizardNext: "Continuar",
    menuWizardPublish: "Publicar mi carta",
    menuWizardQrLater: "Tu código QR aparecerá aquí en cuanto se guarde tu carta.",
    menuWizardNewSectionPlaceholder: "Nueva sección (Pizzas, Salsas…)",
    menuWizardEmptySection: "Todavía no hay platos en esta sección.",
    menuWizardPublished: "Carta publicada",
    menuWizardAdvanced: "Ajustes avanzados (logo, colores, recetas…)",
    menuWizardBackToSimple: "← Volver al editor simple",
    ...
    scanPriceInconsistent: "Diferencia con el total impreso — a menudo un impuesto (accisa, ecotasa...) no detallado aparte, no necesariamente un error.",
    scanExpectedTotal: "esperado", scanPrintedTotal: "impreso:",
    scanPriceInconsistentNote: "Pequeña diferencia con el total impreso (a menudo un impuesto aparte) — échale un vistazo si quieres, no necesariamente un error.",
    scanPackagePriceUncertain: "Este precio por kg/L no se pudo verificar automáticamente — esta factura parece contar de otra forma (ej: precio por botella dentro de un lote) de lo que la app sabe leer. Compruébalo antes de importar.",
    ...
    digitalMenuHint: "Genera una carta pública (con código QR) a partir de tus recetas y tus platos. Para una receta, actualiza el precio mostrado cuando quieras, con un clic desde su ficha.",
    ...
    digitalMenuRecipesLabel: "Recetas mostradas en la carta", digitalMenuNoRecipes: "Crea una receta para poder añadirla a la carta.", digitalMenuRecipeFilterPlaceholder: "Buscar una receta...",
    ...
    digitalMenuPreview: "Ver la carta", digitalMenuQrAfterPublish: "El código QR aparece una vez publicada la carta.", digitalMenuTranslateHint: "Traducir a:",
    ...
    marginBelowFloorMsg: "Se alcanzó tu objetivo personalizado, pero el margen sigue por debajo del umbral de seguridad del 70% — vigílalo de todos modos.",
    ...
    landingHeroSubtitle: "Mira lo que pasa cada vez que escaneas una factura.",
    landingWowScanning: "Escaneando...",
    landingWowResultBanner: "5 líneas importadas",
    landingWowSupplier: "Metro · 12 de marzo",
    landingWowResultConfirm: "Precios actualizados automáticamente",
    landingWowLater: "Unas semanas después, la factura cambia...",
    landingWowRecipeIntro: "Tu receta « Bœuf bourguignon » ya lo sabe",
    landingWowRecipeOutro: "Visto y corregido antes de que te cueste caro — no a fin de mes.",
    ...
    reopenTutorialButton: "Ver el tutorial de nuevo",
    tutorial_welcome_title: "Bienvenido a Chefup",
    tutorial_welcome_body: "La app que calcula el margen de cada uno de tus platos, automáticamente. Un vistazo rápido en 3 pasos antes de empezar.",
    tutorial_scan_title: "Escanea tus facturas de proveedores",
    tutorial_scan_body: "Toca la factura de abajo para ver lo que pasa en cada escaneo real: los precios se rellenan solos, sin volver a teclear nada.",
    tutorialScanTapPrompt: "Tocar para escanear",
    tutorialWowCTA: "¡Vamos!",
    tutorialWowResultBanner: "5 líneas importadas",
    tutorialWowSupplier: "Metro · 12 de marzo",
    tutorialWowResultConfirm: "Precios actualizados en tu almacén",
    tutorialWowLater: "Unas semanas después, vuelves a escanear la misma factura...",
    tutorialWowRecipeIntro: "Tu receta « Bœuf bourguignon » ya lo sabe",
    tutorialWowRecipeOutro: "Ves el impacto al instante — no a fin de mes.",
    tutorial_recipe_title: "Crea tus recetas",
    tutorial_recipe_body: "Añade los ingredientes de un plato y su precio de venta: el margen se calcula solo, y se actualiza en cuanto cambia un precio.",
    tutorial_allergens_title: "Tu ficha de alérgenos, generada sola",
    tutorial_allergens_body: "Cada alérgeno se detecta automáticamente a partir de los ingredientes de tus recetas — imprime una ficha completa en un clic, sin rellenar nada a mano.",
    tutorial_technicalSheet_title: "Una ficha técnica lista para imprimir",
    tutorial_technicalSheet_body: "Cada receta tiene su propia ficha técnica imprimible: ingredientes, cantidades, alérgenos — perfecta para archivar o colgar en la cocina.",
    tutorial_digitalMenu_title: "Tu carta digital en unos clics",
    tutorial_digitalMenu_body: "Convierte tus recetas en una carta pública real con código QR, para poner en tus mesas o compartir online — sin rediseñar nada.",
    tutorial_pantry_title: "Tu despensa siempre al día",
    tutorial_pantry_body: "Cada ingrediente guarda su historial de precios por proveedor — ves al instante si un precio ha subido, y su impacto en tus márgenes.",
  ...
  en: {
    ...
    recipes: "Recipes", avgMarginLabel: "avg. margin", newRecipe: "New recipe", newRecipeName: "New recipe",
    newRecipeChoiceTitle: "How do you want to create your recipe?",
    newRecipeFromScratch: "Start from scratch",
    expressRecipeOption: "Express recipe",
    expressRecipeHint: "Type a dish name, the app suggests ingredients and quantities with estimated prices — fix them with your real invoices.",
    expressRecipeNamePlaceholder: "E.g. Caesar salad",
    expressRecipePortionsLabel: "Servings",
    expressRecipeGenerateButton: "Generate",
    expressRecipeLoading: "Generating…",
    expressRecipeError: "Couldn't generate this recipe right now. Try again, or start from a blank sheet.",
    dailyDishTab: "Daily specials", newDailyDish: "New daily special",
    dailyDishHint: "The app suggests a dish from what's already in your pantry, or you add your own ingredients — both with a sell price already set so you see your margin right away.",
    dailyDishNamePlaceholder: "Dish name (optional)",
    dailyDishNameToggle: "+ Give it a name (optional)",
    dailyDishWantedLabel: "Ingredients to use (optional)",
    dailyDishWantedPlaceholder: "E.g. chicken, ground beef",
    dailyDishExcludedLabel: "Ingredients to avoid (optional)",
    dailyDishExcludedPlaceholder: "E.g. beef, salmon",
    dailyDishPreviewHint: "Nothing is created yet. Missing an ingredient? Remove it: a new coherent suggestion without it is generated.",
    dailyDishRemoveLine: "I don't have this",
    dailyDishPreviewCost: "Total cost:", dailyDishPreviewMargin: "Margin:",
    dailyDishValidateButton: "Validate this dish", dailyDishRegenerateButton: "Regenerate",
    dailyDishFromStockButton: "Suggest a dish", dailyDishQuickAddButton: "Quick add (no AI)",
    dailyDishDefaultName: "Daily special",
    noDailyDishYet: "No daily special yet.",
    ...
    quickAddEstimateHint: "Type any ingredient name: an estimated price fills in automatically, fix it later if needed.",
    ...
    recipeVatLabel: "Tax rate for this recipe", recipeVatResetToDefault: (rate) => `Reset to default tax rate (${rate}%)`,
    menuPriceOutdatedHint: "The price on your menu isn't up to date yet.", menuPricePushButton: "Update on menu", menuPricePushSuccess: "Price updated on the digital menu.",
    saveRecipeButton: "Save", saveRecipeSaving: "Saving…", saveRecipeSaved: "Saved", saveRecipeError: "Save failed, try again.",
    addToMenuButton: "Add to digital menu", onMenuLabel: "On digital menu", addToMenuTitle: "Add to digital menu",
    addToMenuHint: (name) => `Choose the section where "${name}" should appear on your public menu.`,
    menuSectionPickLabel: "Section", addToMenuConfirm: "Add",
    digitalMenuFromRecipeHint: "From a recipe", digitalMenuRemoveFromMenu: "Remove from menu",
    digitalMenuDishesLabel: "Dishes on the menu", digitalMenuPickRecipeButton: "Add an existing recipe",
    digitalMenuNoPickableRecipes: "All your recipes are already on the menu, or none match.",
    digitalMenuManageSections: "Reorder sections", digitalMenuQuickAddLabel: "Add your dish and its price",
    digitalMenuNoDishesYet: "No dishes on the menu yet.",
    digitalMenuPersonalizeButton: "Customize my menu", digitalMenuViewCardButton: "View my menu", digitalMenuAddDishesButton: "Add dishes",
    ...
    launchSpotsLeft: (n) => (n > 1 ? `Only ${n} spots left` : n === 1 ? "Last spot!" : "All spots are taken"),
    ...
    menuWizardStep1Title: "What's your restaurant called?",
    menuWizardStep1Hint: "This is the name your customers will see at the top of the menu.",
    menuWizardNamePlaceholder: "Marius's, The Golden Table…",
    menuWizardStep2Title: "Add your dishes",
    menuWizardStep2Hint: "Pick a section, then type your dishes one after another. You can change everything later.",
    menuWizardDishPlaceholder: "House burger, Coke 33cl…",
    menuWizardDishTip: "Tip: press Enter to go straight to the next dish.",
    menuWizardStep3Title: "Pick your style",
    menuWizardStep3Hint: "How your menu looks when a customer scans the QR code.",
    menuWizardStep4Title: "Your menu is ready!",
    menuWizardStep4Hint: "Print this QR code and put it on your tables. Your prices will update on their own.",
    menuWizardPreview: "See my menu as a customer",
    menuWizardNext: "Continue",
    menuWizardPublish: "Publish my menu",
    menuWizardQrLater: "Your QR code will appear here as soon as your menu is saved.",
    menuWizardNewSectionPlaceholder: "New section (Pizzas, Sauces…)",
    menuWizardEmptySection: "No dishes in this section yet.",
    menuWizardPublished: "Menu published",
    menuWizardAdvanced: "Advanced settings (logo, colours, recipes…)",
    menuWizardBackToSimple: "← Back to the simple editor",
    ...
    scanPriceInconsistent: "Mismatch with the printed total — often a tax (excise duty, eco-fee...) not itemized separately, not necessarily an error.",
    scanExpectedTotal: "expected", scanPrintedTotal: "printed:",
    scanPriceInconsistentNote: "Small mismatch with the printed total (often a separate tax) — take a look if you want, not necessarily an error.",
    scanPackagePriceUncertain: "This price per kg/L couldn't be verified automatically — this invoice seems to count differently (e.g. price per bottle within a pack) than what the app can read. Please check it before importing.",
    ...
    digitalMenuHint: "Generate a public menu (with QR code) from your recipes and dishes. For a recipe, update the shown price whenever you want, with one click from its sheet.",
    ...
    digitalMenuRecipesLabel: "Recipes shown on the menu", digitalMenuNoRecipes: "Create a recipe to add it to the menu.", digitalMenuRecipeFilterPlaceholder: "Search a recipe...",
    ...
    digitalMenuPreview: "View menu", digitalMenuQrAfterPublish: "The QR code appears once the menu is published.", digitalMenuTranslateHint: "Translate to:",
    ...
    marginBelowFloorMsg: "Your custom target is met, but the margin is still below the 70% safety threshold — worth keeping an eye on.",
    ...
    landingHeroSubtitle: "Watch what happens every time you scan an invoice.",
    landingWowScanning: "Scanning...",
    landingWowResultBanner: "5 lines imported",
    landingWowSupplier: "Metro · March 12",
    landingWowResultConfirm: "Prices updated automatically",
    landingWowLater: "A few weeks later, the invoice changes...",
    landingWowRecipeIntro: "Your \"Bœuf bourguignon\" recipe already knows",
    landingWowRecipeOutro: "Seen and fixed before it costs you — not at the end of the month.",
    ...
    reopenTutorialButton: "Watch the tutorial again",
    tutorial_welcome_title: "Welcome to Chefup",
    tutorial_welcome_body: "The app that calculates the margin on every one of your dishes, automatically. A quick 3-step tour before you start.",
    tutorial_scan_title: "Scan your supplier invoices",
    tutorial_scan_body: "Tap the invoice below to see what happens on every real scan: prices fill themselves in, nothing to retype.",
    tutorialScanTapPrompt: "Tap to scan",
    tutorialWowCTA: "Let's go!",
    tutorialWowResultBanner: "5 lines imported",
    tutorialWowSupplier: "Metro · March 12",
    tutorialWowResultConfirm: "Prices updated in your pantry",
    tutorialWowLater: "A few weeks later, you scan the same invoice again...",
    tutorialWowRecipeIntro: "Your \"Bœuf bourguignon\" recipe already knows",
    tutorialWowRecipeOutro: "You see the impact right away — not at the end of the month.",
    tutorial_recipe_title: "Create your recipes",
    tutorial_recipe_body: "Add a dish's ingredients and its selling price: the margin calculates itself, and updates the moment a price changes.",
    tutorial_allergens_title: "Your allergen sheet, generated by itself",
    tutorial_allergens_body: "Every allergen is detected automatically from your recipes' ingredients — print a complete sheet in one click, never fill it in by hand.",
    tutorial_technicalSheet_title: "A technical sheet ready to print",
    tutorial_technicalSheet_body: "Every recipe has its own printable technical sheet: ingredients, quantities, allergens — perfect to file away or post up in the kitchen.",
    tutorial_digitalMenu_title: "Your digital menu in a few clicks",
    tutorial_digitalMenu_body: "Turn your recipes into a real public menu with a QR code, to put on your tables or share online — nothing to redesign.",
    tutorial_pantry_title: "Your pantry, always up to date",
    tutorial_pantry_body: "Every ingredient keeps its price history per supplier — see instantly if a price went up, and its impact on your margins.",
