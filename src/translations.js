...
export const TR = {
  fr: {
    ...
    firstRunScanTitle: "Regarde ce que fait un scan",
    firstRunScanHint: "Facture de démo : voilà ce qui se passe quand tu scannes une vraie facture.",
    firstRunScanAnalyzing: "Analyse de la facture…",
    firstRunScanAddDemo: (name) => `Ajouter à « ${name} »`,
    firstRunScanReal: "Scanner ma vraie facture maintenant",
    wowMomentHint: "Ta marge vient de se calculer toute seule, comme après un vrai scan.",
  ...
  es: {
    ...
    firstRunScanTitle: "Mira lo que hace un escaneo",
    firstRunScanHint: "Factura de demostración: esto es lo que pasa cuando escaneas una factura real.",
    firstRunScanAnalyzing: "Analizando la factura…",
    firstRunScanAddDemo: (name) => `Añadir a « ${name} »`,
    firstRunScanReal: "Escanear mi factura real ahora",
    wowMomentHint: "Tu margen se acaba de calcular solo, como tras un escaneo real.",
  ...
  en: {
    ...
    firstRunScanTitle: "See what a scan does",
    firstRunScanHint: "Demo invoice: here is what happens when you scan a real invoice.",
    firstRunScanAnalyzing: "Analyzing the invoice…",
    firstRunScanAddDemo: (name) => `Add to "${name}"`,
    firstRunScanReal: "Scan my real invoice now",
    wowMomentHint: "Your margin just calculated itself, exactly like after a real scan.",
